    ...
    module Reminders
      ...
      def reminders_stage(options={})
        ...
        begin
          ...
          run_cmd %Q{rsync -ave ssh --delete --force --exclude='storage/*/*/**' --exclude='vendor/' --exclude='.git/' --exclude='.gitignore' --exclude='.env' --filter "protect .env" --filter "protect down" --filter "protect vendor/" --filter "protect storage/*/**" #{reminders_git_checkout_path}/ #{reminders_user}@#{reminders_stage_ip}:#{site_path}}
      ...
      def reminders_prod(options={})
        ...
        begin
          ...
          # sync new app contents
          run_cmd %Q{ssh #{reminders_user}@#{reminders_stage_ip} "rsync -ave ssh --delete --force --exclude='storage/*/*/**' --exclude='storage/*/**' --exclude='.env' --filter 'protect .env' --filter 'protect down' --filter 'protect storage/*/**' #{site_path}/ #{reminders_user}@#{reminders_prod_ip}:#{site_path}"}

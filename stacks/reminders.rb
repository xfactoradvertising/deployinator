    ...
    module Reminders
      ...
      def reminders_stage(options={})
        ...
        begin
          ...
          run_cmd %Q{rsync -ave ssh --delete --force --exclude='app/storage/*' #{reminders_git_checkout_path} --exclude='/vendor/' --exclude='.git/' --exclude='.gitignore' --filter "protect .env.stage.php" --filter "protect down" --filter "protect reminders/vendor/" #{reminders_user}@#{reminders_stage_ip}:#{site_root}}

    ...
    module Endostudynow
      ...
      def endostudynow_stage(options={})
        ...
        begin
          ...
          run_cmd %Q{rsync -ave ssh --delete --force --exclude='app/storage/*' #{endostudynow_git_checkout_path} --exclude='/vendor/' --exclude='.git/' --exclude='.gitignore' --filter "protect .env.stage.php" --filter "protect down" --filter "protect /vendor/" #{endostudynow_user}@#{endostudynow_stage_ip}:#{site_root}}

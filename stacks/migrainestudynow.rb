    ...
    module Migrainestudynow
      ...
      def migrainestudynow_dev(options={})
        ...
        begin
          ...
          run_cmd %Q{rsync -av --delete --force --exclude='app/storage/*' --exclude='vendor/' --exclude='.git/' --exclude='.gitignore' --include='app/storage/meta/services.json' #{migrainestudynow_git_checkout_path}/ #{site_path}}
